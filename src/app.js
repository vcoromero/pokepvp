...
/**
 * Builds and returns the Express app (no listen).
 * Used for testing with supertest and for starting the server in index.js.
 * @param {Object} [options] - Optional overrides for testing (e.g. catalogPort).
